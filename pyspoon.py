...
def make_app(app, callbacks:{str: callable} or callable, *, route:str='/') -> Flask:
    def respond():
    ...
    respond.__name__ = 'generated_response_func__' + str(random.randint(1, 9999999999999999999))
    # return data, 200
    return app.route(route, methods=['POST'])(respond)
